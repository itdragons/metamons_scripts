!function e(t, r, n) {
        ...
        class l extends i.Duplex {
            ...
            _write(e, t, r) {
                ...
                return o
                    ? (o !== u && o.push(i),
                    r())
                    : (console.warn(`ObjectMultiplex - orphaned data for stream "${n}"`),
                    r())
            }
        }
        r.ObjectMultiplex = l
    ...
    14: [function(e, t, r) {
        (function(r, n) {
                ...
                null === t
                    ...
                    o
                        ...
                        : s.objectMode || t && t.length > 0
                            ? ('string' == typeof t || s.objectMode || Object.getPrototypeOf(t) === l.prototype || (t = function(e) {
                                return l.from(e)
                            }(t)),
                            n
                                ? s.endEmitted ? e.emit('error', new Error('stream.unshift() after end event')) : _(e, s, t, !0)
                                : s.ended
            ...
            w.prototype.push = function(e, t) {
                ...
                return n.objectMode
                    ? r = !0
                    : 'string' == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = l.from(e, t),
                    t = ''),
                    r = !0),
                v(this, e, t, !1, r)
            }
            ...
            w.prototype.pipe = function(e, t) {
                ...
                function g(t) {
                    h('ondata'),
                    p = !1,
                    !1 !== e.write(t) || p || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== L(o.pipes, e)) && !d && (h('false write response, pause', n._readableState.awaitDrain),
                ...
                if (e._writev && r && r.next) {
                    ...
                    for (; r;) {
                        var l = r.chunk,
                            c = r.encoding,
                            f = r.callback
                        if (w(e, t, !1, t.objectMode ? 1 : l.length, l, c, f),
                        r = r.next,
                        t.writing)
                            break
                    }
    ...
    23: [function(e, t, r) {
        ...
        class p extends u.default {
            constructor(e, {jsonRpcStreamName: t = 'metamask-provider', logger: r = console, maxEventListeners: n = 100} = {}) {
                if (super(),
                !f.duplex(e))
                ...
                i.default(this._jsonRpcConnection.stream, u.createStream(t), this._jsonRpcConnection.stream, this._handleStreamDisconnect.bind(this, 'MetaMask RpcProvider'))
                        ...
                        : 'metamask_unlockStateChanged' === r
                            ...
                            : 'metamask_chainChanged' === r
                                ...
                                : h.EMITTED_NOTIFICATIONS.includes(r)
                                    ...
                                    : 'METAMASK_STREAM_FAILURE' === r && e.destroy(new Error(d.default.errors.permanentlyDisconnected()))
                }
                ))
            }
            isConnected() {
            ...
            _handleDisconnect(e, t) {
                if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !e) {
                    ...
                    e
                        ? (r = new c.EthereumRpcError(1013, t || d.default.errors.disconnected()),
                        this._log.debug(r))
                        : (r = new c.EthereumRpcError(1011, t || d.default.errors.permanentlyDisconnected()),
                        this._log.error(r),
                        this.chainId = null,
            ...
            _handleAccountsChanged(e, t = !1) {
                ...
                l.default(this._state.accounts, r) || (t && null !== this._state.accounts && this._log.error('MetaMask: \'eth_accounts\' unexpectedly updated accounts. Please report this bug.', r),
            ...
            _handleUnlockStateChanged({accounts: e, isUnlocked: t} = {}) {
                'boolean' == typeof t
                    ? t !== this._state.isUnlocked && (this._state.isUnlocked = t,
                    this._handleAccountsChanged(e || []))
    ...
    24: [function(e, t, r) {
        ...
        class l extends u.default {
            constructor(e, {jsonRpcStreamName: t = 'metamask-provider', logger: r = console, maxEventListeners: n = 100, shouldSendMetadata: i = !0} = {}) {
                if (super(e, {
                    jsonRpcStreamName: t,
                    logger: r,
                    maxEventListeners: n
            ...
            _warnOfDeprecation(e) {
                var t
                !1 === (null === (t = this._sentWarnings) || void 0 === t ? void 0 : t.events[e]) && (this._log.warn(s.default.warnings.events[e]),
            ...
            send(e, t) {
                ...
                'string' != typeof e || t && !Array.isArray(t)
                    ? e && 'object' == typeof e && 'function' == typeof t ? this._rpcRequest(e, t) : this._sendSync(e)
                    : new Promise(((r, n) => {
                        try {
                            this._rpcRequest({
                                method: e,
            ...
            _handleChainChanged({chainId: e, networkVersion: t} = {}) {
                ...
                t && 'loading' !== t && t !== this.networkVersion && (this.networkVersion = t,
    ...
    25: [function(e, t, r) {
        ...
        r.initializeProvider = function({connectionStream: e, jsonRpcStreamName: t, logger: r = console, maxEventListeners: n = 100, shouldSendMetadata: a = !0, shouldSetOnWindow: u = !0, shouldShimWeb3: l = !1}) {
    ...
    27: [function(e, t, r) {
        ...
        r.default = function(e, t = console) {
            ...
            if (!window.web3) {
                ...
                o = new Proxy(o, {
                    get: (o, s, ...a) => ('currentProvider' !== s || r
                        ? 'currentProvider' === s || s === i || n || (n = !0,
        ...
        r.createErrorMiddleware = function(e) {
            return (t, r, i) => {
                ...
                i((t => {
                    const {error: n} = r
                    return n
                        ? (e.error(`MetaMask - RPC Error: ${n.message}`, n),
                        t())
                        : t()
                }
                ))
 ...
 */
        ...
        function k(e, t, r) {
            ...
            for (var n = [], i = t; i < r;) {
                var o, s, a, u, l = e[i], c = null, f = l > 239 ? 4 : l > 223 ? 3 : l > 191 ? 2 : 1
                if (i + f <= r)
                    switch (f) {
                        case 1:
                            l < 128 && (c = l)
                        ...
                        case 3:
                            o = e[i + 1],
                            s = e[i + 2],
                            128 == (192 & o) && 128 == (192 & s) && (u = (15 & l) << 12 | (63 & o) << 6 | 63 & s) > 2047 && (u < 55296 || u > 57343) && (c = u)
                            break
                        case 4:
                            o = e[i + 1],
                            s = e[i + 2],
        ...
        a.prototype.compare = function(e, t, r, n, i) {
            ...
            if (this === e)
                return 0
            for (var o = (i >>>= 0) - (n >>>= 0), s = (r >>>= 0) - (t >>>= 0), u = Math.min(o, s), l = this.slice(n, i), c = e.slice(t, r), f = 0; f < u; ++f)
                if (l[f] !== c[f]) {
                    o = l[f],
                    s = c[f]
                    break
    ...
    39: [function(e, t, r) {
        ...
        function m(e, t, r, i) {
            ...
            if ((s = e._events)
                ? (s.newListener && (e.emit('newListener', t, r.listener ? r.listener : r),
                s = e._events),
                a = s[t])
                : (s = e._events = n(null),
                e._eventsCount = 0),
        ...
        s.prototype.removeAllListeners = function(e) {
            ...
            if (!r.removeListener)
                return 0 === arguments.length
                    ? (this._events = n(null),
                    this._eventsCount = 0)
                    : r[e] && (0 == --this._eventsCount ? this._events = n(null) : delete r[e]),
                this
            ...
            var n = e('once'),
                ...
                o = function(e, t, s) {
                    ...
                    var a = e._writableState,
                        ...
                        y = function() {
                            if (!f)
                                return (!l || u && u.ended && !u.destroyed) && (!c || a && a.ended && !a.destroyed) ? void 0 : s.call(e, new Error('premature close'))
                        },
                        w = function() {
                            e.req.on('finish', h)
                        }
    ...
    46: [function(e, t, r) {
        ...
        r.serializeError = function(e, {fallbackError: t = s, shouldIncludeStack: r = !1} = {}) {
            ...
            return r && e && d && 'string' == typeof d && (l.stack = d),
            l
        }
    },
    {
    ...
    47: [function(e, t, r) {
        ...
        function o(e, t, r) {
            var o
            for (s(e, '', [], void 0),
            o = 0 === i.length ? JSON.stringify(e, t, r) : JSON.stringify(e, c(t), r); 0 !== n.length;) {
                var a = n.pop()
        ...
        function u(e, t, r) {
            var o, s = l(e, '', [], void 0) || e
            for (o = 0 === i.length ? JSON.stringify(s, t, r) : JSON.stringify(s, c(t), r); 0 !== n.length;) {
                var a = n.pop()
                4 === a.length ? Object.defineProperty(a[0], a[1], a[3]) : a[0][a[1]] = a[2]
            }
            return o
    ...
    48: [function(e, t, r) {
        ...
        r.read = function(e, t, r, n, i) {
            var o, s, a = 8 * i - n - 1, u = (1 << a) - 1, l = u >> 1, c = -7, f = r ? i - 1 : 0, d = r ? -1 : 1, h = e[t + f]
            for (f += d,
            o = h & (1 << -c) - 1,
            h >>= -c,
            c += a; c > 0; o = 256 * o + e[t + f],
                f += d,
                c -= 8)
                ;
            for (s = o & (1 << -c) - 1,
            o >>= -c,
            c += n; c > 0; s = 256 * s + e[t + f],
                f += d,
                c -= 8)
                ;
            if (0 === o)
        ...
        r.write = function(e, t, r, n, i, o) {
            var s, a, u, l = 8 * o - i - 1, c = (1 << l) - 1, f = c >> 1, d = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = n ? 0 : o - 1, p = n ? 1 : -1, g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0
            for (t = Math.abs(t),
            isNaN(t) || t === 1 / 0
                ? (a = isNaN(t) ? 1 : 0,
                s = c)
 ...
 */
                ...
                return new Promise((i => {
                    const s = e => {
                        ...
                        u = r => {
                            t.error
                                ? s(t.error)
                                : (r && ('function' != typeof r && s(new o.EthereumRpcError(o.errorCodes.rpc.internal, `JsonRpcEngine: "next" return handlers must be functions. Received "${typeof r}" for request:\n${a(e)}`, {
                                    request: e
                                })),
                                n.push(r)),
                                i([null, !1]))
    ...
    59: [function(e, t, r) {
        !function(e, r) {
            ...
            function i(r) {
                ...
                typeof console !== t && (void 0 !== console[r] ? n(console, r) : void 0 !== console.log ? n(console, 'log') : e)
            }
            function o(t, n) {
            ...
            l.getLogger = function(e) {
                ...
                var t = c[e]
                return t || (t = c[e] = new u(e, l.getLevel(), l.methodFactory)),
                t
            }

            var f = typeof window !== t ? window.log : void 0
            return l.noConflict = function() {
                return typeof window !== t && window.log === l && (window.log = f),
                l
            }
            ,
                        ...
                        if (!c && !f)
                            ...
                            function(e) {
                                ...
                                : function(e) {
                                    ...
                                    ? e.abort()
                                    : u(e.destroy) ? e.destroy() : void l(t || new Error('stream was destroyed'))
                    }
                },
                c = function(e) {
                    e()
    ...
    72: [function(e, t, r) {
        (function(e) {
            'use strict'
            void 0 === e || !e.version || 0 === e.version.indexOf('v0.') || 0 === e.version.indexOf('v1.') && 0 !== e.version.indexOf('v1.8.')
                ? t.exports = {
    ...
    76: [function(e, t, r) {
        (function(t, n) {
            ...
            ,
            r.setImmediate = 'function' == typeof t
                ? t
                : function(e) {
                    var t = u++,
            ...
            ,
            r.clearImmediate = 'function' == typeof n
                ? n
                : function(e) {
                    delete a[e]
                }
